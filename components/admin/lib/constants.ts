...
export const TOOLS: { id: Tool; key: string; icon: string; label: string; hint: string }[] = [
  ...
  { id: 'terrain', key: 'r', icon: '⛰', label: 'terrain', hint: 'water mode — the rest of the map is locked · tap to drop anchors, snap onto the first point (or ⏎) to close · ⌫ undo a point · drag a piece to move, drag its points to reshape' },
