...
const btn: React.CSSProperties = { fontFamily: 'var(--font-mono)', fontSize: '0.66rem', textTransform: 'uppercase', letterSpacing: '0.08em', background: 'none', border: '2px solid var(--ink)', color: 'var(--ink)', padding: '8px 12px', textDecoration: 'none', cursor: 'pointer' };
const digest: React.CSSProperties = { fontFamily: 'var(--font-mono)', fontSize: '0.55rem', opacity: 0.5, marginTop: 16 };
