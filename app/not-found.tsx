...
const code: React.CSSProperties = { fontFamily: 'var(--font-sans)', fontSize: '3.2rem', fontWeight: 700, lineHeight: 1, margin: '10px 0 4px' };
...
const btn: React.CSSProperties = { display: 'inline-block', fontFamily: 'var(--font-sans)', fontSize: '0.66rem', textTransform: 'uppercase', letterSpacing: '0.08em', border: '2px solid var(--ink)', color: 'var(--ink)', padding: '8px 12px', textDecoration: 'none' };
